...
% reviewDINArtifactUI
% Interactive DIN artifact reviewer with TILEDLAYOUT and color toggling.
% **NOW INCLUDES OPTIONAL FIGURE SAVING**
% Layout per row (7 tiles): [1] Topoplot | [2-4] Time (windowed) | [5-7] |FFT| (same window)
% Click anywhere in a row to toggle membership: DIN (red) <-> candidate (green).
% Auto-centers and clamps figure position to stay on-screen.
%
% Inputs (New Inputs Bolded):
%   W, xICA, fs, chanlocs : as in your pipeline
%   dinSrc      : components pre-flagged for REJECT (start red)
